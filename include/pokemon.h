...
extern const u8 gItemEffect_MetalCoat[];
extern const u8 gItemEffect_KingsRock[];
extern const u8 gItemEffect_DragonScale[];
extern const u8 gItemEffect_UpGrade[];
extern const u8 gItemEffect_DeepSeaTooth[];
extern const u8 gItemEffect_DeepSeaScale[];
