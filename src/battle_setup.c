...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SIDNEY] = REMATCH(TRAINER_SIDNEY, TRAINER_SIDNEY_REMATCH, TRAINER_SIDNEY_REMATCH, TRAINER_SIDNEY_REMATCH, TRAINER_SIDNEY_REMATCH, MAP_EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_PHOEBE, TRAINER_PHOEBE_REMATCH, TRAINER_PHOEBE_REMATCH, TRAINER_PHOEBE_REMATCH, TRAINER_PHOEBE_REMATCH, MAP_EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_GLACIA, TRAINER_GLACIA_REMATCH, TRAINER_GLACIA_REMATCH, TRAINER_GLACIA_REMATCH, TRAINER_GLACIA_REMATCH, MAP_EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_DRAKE, TRAINER_DRAKE_REMATCH, TRAINER_DRAKE_REMATCH, TRAINER_DRAKE_REMATCH, TRAINER_DRAKE_REMATCH, MAP_EVER_GRANDE_CITY),
    [REMATCH_WALLACE] = REMATCH(TRAINER_WALLACE, TRAINER_WALLACE_REMATCH, TRAINER_WALLACE_REMATCH, TRAINER_WALLACE_REMATCH, TRAINER_WALLACE_REMATCH, MAP_EVER_GRANDE_CITY),
};
...
static u8 GetTrainerBattleTransition(void)
{
    ...
    if (gTrainers[gTrainerBattleOpponent_A].trainerClass == TRAINER_CLASS_ELITE_FOUR)
    {
        if (gTrainerBattleOpponent_A == TRAINER_SIDNEY
         || gTrainerBattleOpponent_A == TRAINER_SIDNEY_REMATCH
         || gTrainerBattleOpponent_A == TRAINER_SIDNEY_REMATCH_2)
            return B_TRANSITION_SIDNEY;
        if (gTrainerBattleOpponent_A == TRAINER_PHOEBE
         || gTrainerBattleOpponent_A == TRAINER_PHOEBE_REMATCH
         || gTrainerBattleOpponent_A == TRAINER_PHOEBE_REMATCH_2)
            return B_TRANSITION_PHOEBE;
        if (gTrainerBattleOpponent_A == TRAINER_GLACIA
         || gTrainerBattleOpponent_A == TRAINER_GLACIA_REMATCH
         || gTrainerBattleOpponent_A == TRAINER_GLACIA_REMATCH_2)
            return B_TRANSITION_GLACIA;
        if (gTrainerBattleOpponent_A == TRAINER_DRAKE
         || gTrainerBattleOpponent_A == TRAINER_DRAKE_REMATCH
         || gTrainerBattleOpponent_A == TRAINER_DRAKE_REMATCH_2)
